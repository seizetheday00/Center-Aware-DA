...
class Driver(ImageList):
    ...
    image_list = {
        "aucrand": "image_list/aucrand.txt",
        "statefarm": "image_list/statefarm.txt",
        "ours": "image_list/ours.txt",
    }
    CLASSES = ['Safe driving', 'Texting Right', 'Talking on the Phone Right', 'Texting Left', 
                ...
                'Reaching behind', 'Hair and makeup', 'Talking to passengers']
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = False, **kwargs):
        ...
        super(Driver, self).__init__(root, Driver.CLASSES, data_list_file=data_list_file, **kwargs)
